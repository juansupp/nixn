  ...
  retirar(ev) {
    ...
    this.insertOrden().then(orden => {
      ...
      this.activosretiro.forEach(activo => {
        ...
        this.attachretiro(activo.id_sub_entrega,orden); //async
